...
- BEFORE: Seq Scan, Cost: 0.00..25.00, Actual Time: 0.5ms
- AFTER: Index Scan using idx_user_email, Cost: 0.00..8.00, Actual Time: 0.1ms
- IMPROVEMENT: 80% faster

QUERY 2 - Property Search:
- BEFORE: Seq Scan, Cost: 0.00..30.00, Actual Time: 1.2ms  
- AFTER: Index Scan using idx_property_search, Cost: 0.00..12.00, Actual Time: 0.3ms
- IMPROVEMENT: 75% faster

QUERY 3 - Booking History:
- BEFORE: Nested Loop, Cost: 0.00..45.00, Actual Time: 2.1ms
- AFTER: Index Scan + Nested Loop, Cost: 0.00..18.00, Actual Time: 0.7ms
